...
function Editor({ filePath, content, language, previousContent, onSave, onContentChange, onRun, isDirty, onDirtyChange, onSnippetInsert, debugSession, onBreakpointToggle, onBreakpointRemove }) {
  ...
  }, [autoSaveEnabled, content, filePath, onDirtyChange, onSave, onRun, previousContent, snippets, handleBreakpointToggle]);
  ...
  const handleBreakpointToggle = useCallback(async (lineNumber) => {
  ...
  }, [breakpoints, debugSession, filePath, setBreakpoints, onBreakpointToggle, onBreakpointRemove]);
